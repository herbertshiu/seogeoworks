...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero section-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><button className="button-primary" onClick={() => scrollTo("briefings")}>{copy.explore} <ChevronRight size={17} /></button><button className="text-button" onClick={() => scrollTo("voices")}>{copy.meet} <ArrowUpRight size={16} /></button></div>
      ...
      <footer className="site-footer"><a className="wordmark footer-mark" href="https://www.seogeoworks.hk/" onClick={(event) => handleNavClick(event, "top")}><span className="wordmark-dot" />seogeo<span>works</span></a><span>© 2026 seogeoworks. Made for the curious.</span><div className="footer-links"><a href="https://www.seogeoworks.hk/articles/">Field guides</a><a href="https://www.seogeoconsulting.hk/" rel="noopener noreferrer">Consulting</a><a href="https://itehk.com.hk/" rel="noopener noreferrer">Itehk</a><a href="https://www.seogeoworks.hk/llms.txt">llms.txt</a><a href="https://www.seogeoworks.hk/sitemap.xml">Sitemap</a></div></footer>
    </div>
  );
}
