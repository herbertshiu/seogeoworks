...
const uiCopy = {
  en: { navBriefings: "Briefings", navCompare: "SEO vs GEO", navCase: "Case study", navRoi: "ROI calculator", navAudit: "GEO audit", navVoices: "Voices", navNotes: "Field notes", navResearch: "Research desk", navAbout: "About", light: "Light", dark: "Dark", getSignal: "Get the signal", youIn: "You’re in", eyebrow: "The people & patterns behind modern search", heroTitle: "Be findable.", heroStay: "Stay human.", heroBody: "Signal Room is an independent field guide to SEO, GEO, and the operators reshaping how brands get found, understood, and remembered.", explore: "Explore the latest", meet: "Meet the room", compareTitle: "SEO gets you", compareEm: "seen. GEO gets you chosen.", researchTitle: "Latest thinking.", researchEm: "Sharper signals.", auditTitle: "Turn a vague", auditEm: "gap into a plan.", newsletterTitle: "Good thinking,", newsletterEm: "once a week.", newsletterBody: "One thoughtful dispatch on SEO, GEO, and building a brand that machines can understand — and people can feel.", email: "Your email address", welcome: "Welcome to the room.", checkReadiness: "Check your readiness" },
  zhHans: { navBriefings: "研究简报", navCompare: "SEO 对比 GEO", navCase: "案例研究", navRoi: "ROI 计算器", navAudit: "GEO 审计", navVoices: "专家声音", navNotes: "现场笔记", navResearch: "研究中心", navAbout: "关于", light: "浅色", dark: "深色", getSignal: "订阅信号", youIn: "已订阅", eyebrow: "现代搜索背后的人与规律", heroTitle: "让人找到。", heroStay: "保持真实。", heroBody: "Signal Room 是一本独立的 SEO 与 GEO 现场指南，记录正在重塑品牌被发现、理解与记住方式的实践者。", explore: "探索最新内容", meet: "认识专家", compareTitle: "SEO 让你", compareEm: "被看见，GEO 让你被选择。", researchTitle: "最新洞见。", researchEm: "更清晰的信号。", auditTitle: "把模糊的", auditEm: "问题变成计划。", newsletterTitle: "好思考，", newsletterEm: "每周一次。", newsletterBody: "每周一份关于 SEO、GEO，以及如何让机器理解、让人感受到品牌的精选简报。", email: "你的邮箱地址", welcome: "欢迎来到 Signal Room。", checkReadiness: "检查你的准备度" },
  zhHant: { navBriefings: "研究簡報", navCompare: "SEO 對比 GEO", navCase: "案例研究", navRoi: "ROI 計算器", navAudit: "GEO 審計", navVoices: "專家聲音", navNotes: "現場筆記", navResearch: "研究中心", navAbout: "關於", light: "淺色", dark: "深色", getSignal: "訂閱訊號", youIn: "已訂閱", eyebrow: "現代搜尋背後的人與規律", heroTitle: "讓人找到。", heroStay: "保持真實。", heroBody: "Signal Room 是一本獨立的 SEO 與 GEO 現場指南，記錄正在重塑品牌被發現、理解與記住方式的實踐者。", explore: "探索最新內容", meet: "認識專家", compareTitle: "SEO 讓你", compareEm: "被看見，GEO 讓你被選擇。", researchTitle: "最新洞見。", researchEm: "更清晰的訊號。", auditTitle: "把模糊的", auditEm: "問題變成計劃。", newsletterTitle: "好思考，", newsletterEm: "每週一次。", newsletterBody: "每週一份關於 SEO、GEO，以及如何讓機器理解、讓人感受到品牌的精選簡報。", email: "你的電郵地址", welcome: "歡迎來到 Signal Room。", checkReadiness: "檢查你的準備度" },
} as const;
...
function App() {
  ...
  const [language, setLanguage] = useState<keyof typeof uiCopy>(() => (localStorage.getItem("signal-room-language") as keyof typeof uiCopy) || "en");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("signal-room-language", language);
  }, [language]);
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer"><a className="wordmark footer-mark" href="https://www.seogeoworks.hk/" onClick={(event) => handleNavClick(event, "top")}><span className="wordmark-dot" />signal<span>room</span></a><span>© 2026 Signal Room. Made for the curious.</span><div className="footer-links"><a href="https://www.seogeoworks.hk/articles/">Field guides</a><a href="https://www.seogeoconsulting.hk/" rel="noopener noreferrer">Consulting</a><a href="https://itehk.com.hk/" rel="noopener noreferrer">Itehk</a><a href="https://www.seogeoworks.hk/llms.txt">llms.txt</a><a href="https://www.seogeoworks.hk/sitemap.xml">Sitemap</a></div></footer>
    </div>
  );
}
